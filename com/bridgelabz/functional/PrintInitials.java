...
public class PrintInitials {
	...
	public static void main(String[] args)
	{
				...
				else if(( i==3 || i==5 ) && ( j==0 || j==1 || j==4 || j==5 || j==6))
		{
				...
				System.out.print("   ");//to print space between k And D
					
	// to print w.
				
				for(int j=0;j<=30;j++)
				{
					if((i==0)&&( j==0 || j==1 ||  j==15 ||  j==29 ))
							{
						System.out.print("*");
							}
					else if((i==0||i==8)&&(j==0 || j==1 || j==2 ||  j==4 ||  j==5 || j==6 ||  j==7||  j==8 || j==9 ))
					{
						System.out.print("*");
					}
				...
				System.out.print("");//to print space between D And W
